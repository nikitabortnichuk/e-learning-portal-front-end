                ...
                <div className="profile-header-wrapper">
                    <div className="profile-header">
                        ...
                        <div className="profile-header-info">
                            <h2 className="profile-username">Nikita Bortnichuk</h2>
                            <p className="profile-description">Student</p>
                        </div>
                    </div>.
                </div>
                <div className="profile-body">
                    <div className="profile-nav">
                        <ul className="profile-nav-links">
                            <div className="top">
                                <li><a className="profile-nav-link active" href="/profile/description">Description</a></li>
                                <li><a className="profile-nav-link" href="/profile/mycourses">My courses</a></li>
                                <li><a className="profile-nav-link" href="/profile/wishlist">Wishlist</a></li>
                                <li><a className="profile-nav-link" href="/profile/certificates">Certificates</a></li>
                            </div>
                            <li className="logout"><a className="profile-nav-link" href="#">Logout</a></li>
                        </ul>
                    </div>
